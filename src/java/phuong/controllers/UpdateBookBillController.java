 ...
 * @author admin
 */
public class UpdateBookBillController extends HttpServlet {
        ...
        try {
            ...
            for (ProductDTO dto : cart.getCart().values()) {
                if(dto.getProductID().equals(productID)){
                    product = new ProductDTO(productID, dto.getProductName(), dto.getPrice(), quantity, dto.getCategoryID(), dto.getStatusID(), dto.getDescription(), dto.getImage());
                    break;
                }
            }
            cart.update(product);
