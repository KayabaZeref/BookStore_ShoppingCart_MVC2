...
public class AddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO dto = new ProductDTO(productID, productName, price, amount, categoryID, statusID, description, image);
//            ProductDTO dto = new ProductDTO(productID, productName, price, amount, categoryID, statusID, description);
...
//            OrderDTO orderDto = new OrderDTO(orderID, orderDate, address, phone, Float.parseFloat(totalmoney), userID);
            ...
            url = SUCCESS;
            request.setAttribute("MESSAGE", "You pick the book : " + productName + " success");
        } catch (Exception e) {
